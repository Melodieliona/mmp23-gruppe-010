...
namespace Defence
{
    public class LongCannonController : CannonController
    {
        ...
        protected override void UpdateUpgradeText(CannonLevel currentLevel, CannonLevel nextLevel, int gold, int cannonValue)
        {
            ...
            SetPanelText(panel, "Stats1 Text", nextLevel.GetUpgradeBpsText(currentLevel), Color.white);
            SetPanelText(panel, "Stats2 Text", nextLevel.GetUpgradeDamageText(currentLevel), Color.white);
            SetPanelText(panel, "Stats3 Text", nextLevel.GetUpgradeRangeText(currentLevel), Color.white);
